...
// USB registers
#define S_USB_REG_ADDR_ENDP                                                    \
  (*(volatile s_usb_reg_addr_endp_t *)(S_USB_REGS_BASE + 0x00))
...
#define S_USB_REG_SIE_CTRL                                                     \
  (*(volatile s_usb_reg_sie_ctrl_t *)(S_USB_REGS_BASE + 0x4c))
#define S_USB_REG_SIE_STATUS                                                   \
  (*(volatile s_usb_reg_sie_status_t *)(S_USB_REGS_BASE + 0x50))
#define S_USB_REG_INT_EP_CTRL                                                  \
  (*(volatile s_usb_reg_int_ep_ctrl_t *)(S_USB_REGS_BASE + 0x54))
#define S_USB_REG_BUFF_STATUS                                                  \
  (*(volatile s_usb_reg_buff_status_t *)(S_USB_REGS_BASE + 0x58))
...
#define S_USB_REG_USB_MUXING                                                   \
  (*(volatile s_usb_reg_usb_muxing_t *)(S_USB_REGS_BASE + 0x74))
#define S_USB_REG_USB_PWR                                                      \
  (*(volatile s_usb_reg_usb_pwr_t *)(S_USB_REGS_BASE + 0x78))
...
#define S_USB_REG_INTE (*(volatile s_usb_reg_inte_t *)(S_USB_REGS_BASE + 0x90))
#define S_USB_REG_INTF (*(volatile uint32_t *)(S_USB_REGS_BASE + 0x94))
#define S_USB_REG_INTS (*(volatile s_usb_reg_ints_t *)(S_USB_REGS_BASE + 0x98))
